      ...
      iter.foreach(t => {
        ...
        if ((uid != null) && (!uid.equals("")) && (!uid.equals("0")) && (uid.length < 11) && (status != null && (status.equals("2") || status.equals("3")))) {
          ...
          try {
            ...
            case ex: Exception => {
              FileUtil.apppendTofile("/home/hduser/projs/logs/centaccouterror.log", ex.toString + "==" + t.toString())
            }
          }
        }
      })
