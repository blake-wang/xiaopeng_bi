package com.xiaopeng.bi.backend.hisdatarecover
...
object LoadHisData {
  def main(args: Array[String]): Unit = {
      ...
      /*会员*/
      val hysql="select member_id,username,regtime addtime,regtype from views.v_member where to_date(regtime)<='currentday'".replace("currentday",currentday)
